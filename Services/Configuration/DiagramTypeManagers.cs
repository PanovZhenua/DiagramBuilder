        ...
        public DiagramType DetectDiagramType(string text)
        {
            ...
            foreach (string line in lines)
            {
                ...
                if (trimmed.StartsWith("#TYPE:", StringComparison.OrdinalIgnoreCase))
                {
                    ...
                    else if (typeStr == "COMPONENTDIAGRAM" || typeStr == "COMPONENT_DIAGRAM" || typeStr == "COMPONENT" || typeStr == "COMPONENTS")
                        return DiagramType.ComponentDiagram;
                }
                ...
                else if (upperLine.Contains("COMPONENTDIAGRAM") || upperLine.Contains("COMPONENT DIAGRAM") ||
         upperLine.Contains("COMPONENT") || upperLine.Contains("КОМПОНЕНТ") ||
         upperLine.Contains("ДИАГРАММА КОМПОНЕНТОВ"))
                {
                    return DiagramType.ComponentDiagram;
                }
